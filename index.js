...
/*UserDetails.register({ username: "paul" }, "paul", function (err, user) {
  if (err) console.log(err);
});

UserDetails.register({ username: "jay" }, "jay", function (err, user) {
  if (err) console.log(err);
});

UserDetails.register({ username: "roy" }, "roy", function (err, user) {
  if (err) console.log(err);
});*/